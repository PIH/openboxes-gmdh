...
INNER JOIN gmdh_latest_inventory_snapshot AS is2 ON snap.location_id = is2.location_id AND snap.product_id = is2.product_id AND snap.date = maxdate
...
LEFT JOIN gmdh_pending_orders_vw ON product.product_code = gmdh_pending_orders_vw.product_code;
