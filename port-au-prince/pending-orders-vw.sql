 ...
 * Quantities shipped (not yet received) from vendor to Miami Warehouse
 * Quantities pending (not yet shipped) from vendor to Miami Warehouse
 ...
 * Quantities shipped (not yet received) from Miami to Log Center
 * Quantities shipped (not yet received) from Boston to Log Center
